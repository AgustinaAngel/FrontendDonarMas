...
function Navbar() {
  ...
  const [mostrarCrearCampñas, setMostrarCrearCampñas] = useState(false); // Inicialmente mostrarIniciarSesion se establece en false
  ...
  const MostrarloONGCrearCampaña = () => {
    setMostrarCrearCampñas(true); // Cambia el estado a false para ocultar el componente IniciarSesion
  };
  ...
  const CambiarLinkCampaña = () => {
    if (myContextUser.tipo === "ONG") {
      ...
      ocultarIniciarSesion(); // Ocultamos el componente IniciarSesion
    };
            ...
            <ul className="navbar-nav mr-auto d-flex flex-wrap justify-content-evenl">
              ...
              <li className="nav-item d-flex flex-wrap justify-content-evenly">
                <NavLink
                  ...
                  activeclassname="active"
                  to="/campanas"
                  onClick={CambiarLinkCampaña}// Oculta el componente IniciarSesion al hacer clic en el enlace
                >
                  Campañas
                </NavLink>
              </li>
